...
const ERROR_MESSAGES: Record<string, string> = {
	...
	not_configured: "Lark is not configured. Contact your administrator.",
	token_exchange_failed: "Failed to connect to Lark. Please try again.",
};
...
export function ErrorHandler() {
	...
	useEffect(() => {
		...
		window.history.replaceState({}, "", "/integrations/lark");
