			...
			<div className="flex items-start gap-6">
				...
				<div className="flex-1">
					...
					<p className="mt-1 text-muted-foreground">
						Подключайте репозитории GitHub и синхронизируйте Pull Request.
						Отслеживайте CI-статус и ревью всей команды.
					</p>
				</div>
			</div>
			...
			{installation && (
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Репозитории, доступные через установленное GitHub App.
						</CardDescription>
					</CardHeader>
					<CardContent>
