...
export const metadata: Metadata = {
	...
	description:
		"Закрытое сообщество Rox для пользователей, которые ежедневно тратят более 1 миллиарда токенов.",
};
...
const leagueBenefits = [
	...
	"закрытые семинары по агентным конвейерам, промптам и параллельным рабочим деревьям",
	"нетворкинг элиты вайб-кодинга: обмен связками, подтверждениями результата и рабочими стратегиями",
];
					...
					<div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
						<div>
							...
							<p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
								Рейтинг учитывает ежедневный расход токенов. Чем смелее вы
								кормите агентов контекстом, тем выше поднимаетесь и тем ближе
								становитесь к приватным возможностям лиги.
							</p>
						</div>
