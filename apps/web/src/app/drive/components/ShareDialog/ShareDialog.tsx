 ...
 * `rox.one/d/<token>` link. An optional password gates the public landing page.
 */
			...
			<DialogContent>
				...
				{shareUrl ? (
					<div className="space-y-2">
						<Label htmlFor="share-link">Публичная ссылка</Label>
					...
					<div className="space-y-2">
						<Label htmlFor="share-password">Пароль (необязательно)</Label>
						<Input
							id="share-password"
							type="password"
