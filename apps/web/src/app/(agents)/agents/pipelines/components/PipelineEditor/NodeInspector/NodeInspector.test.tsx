 ...
 *
 * `@/trpc/react` is an import-time singleton (it pulls in `@/env`, which validates
 * NEXT_PUBLIC_* at import). We mock it only to satisfy import resolution, then
 * dynamic-import the component and restore the mock so sibling suites are
 * unaffected (mirrors DashboardPresence.test.tsx).
 */
