...
/** Serialise a palette drag payload onto the dataTransfer. */
function setDragData(
	event: React.DragEvent,
	payload: { type: string; roleSlug?: string; label?: string },
) {
 ...
 * replacing the old fixed four-button toolbar.
 *
 ...
 */
export function NodePalette({ v2ProjectId, onAddNode }: NodePaletteProps) {
...
function PaletteChip({
	...
	return (
		<button
			...
			draggable
			onDragStart={(e) =>
				setDragData(e, { type: entry.id, label: entry.label })
			}
			onClick={onAdd}
