 ...
 * one searchable surface (dify/sim parity, ports the desktop NodePalette). Picking
 * an item adds the node at the viewport centre and opens the inspector — the
 * editor owns placement. Named `NodeCommandPalette` on web to avoid colliding with
 * the existing left-dock `NodePalette` (which is the desktop `NodePaletteDock`).
 *
 ...
 * present (fetched only while the palette is open).
 */
