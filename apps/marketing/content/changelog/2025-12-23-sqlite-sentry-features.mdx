...
## SQLite Local Database <PRBadge url="https://github.com/agisota/set/pull/477" />

- Desktop app now uses a local SQLite-backed database with automatic migration from the legacy JSON store
- Adds `@rox/local-db` package with Drizzle ORM schema for SQLite
...
## Sentry Error Tracking <PRBadge url="https://github.com/agisota/set/pull/484" />
...
## Features and FAQ Sections <PRBadge url="https://github.com/agisota/set/pull/472" />
