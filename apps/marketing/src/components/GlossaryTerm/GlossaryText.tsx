...
const GLOSSARY_DEFINITIONS = [
	...
	},
	{
		label: "workspaces",
		description:
			"Рабочие пространства Rox: отдельные среды для задач, агентов, веток и связанных артефактов.",
		kind: "term",
	},
	{
		label: "workspace",
		description:
			"Рабочее пространство Rox: отдельная среда для задачи, агента, ветки и связанных артефактов.",
		kind: "term",
	},
	{
		label: "dashboard",
		description:
			"Панель обзора с метриками, состояниями и быстрыми действиями по рабочим процессам.",
		kind: "term",
	},
	{
		label: "webhooks",
		description:
			"HTTP-события от внешних сервисов, которые могут запускать автоматические действия в Rox.",
		kind: "term",
	},
	{
		label: "providers",
		description:
			"Подключаемые поставщики моделей или сервисов, между которыми Rox может переключаться.",
		kind: "term",
	},
	{
		label: "presets",
		description:
			"Сохранённые наборы настроек, которые ускоряют запуск повторяемых агентских сценариев.",
		kind: "term",
	},
	{
		label: "UI",
		description:
			"Пользовательский интерфейс приложения: экраны, формы, состояния и действия, которые видит человек.",
		kind: "term",
	},
	{
