...
export const FIELD_HINT_LEAD =
	"Юзай где хочешь: локально, в изолированных песочницах, в частном облаке, на древнейшем";
export const FIELD_HINT_TAIL = "пентиуме, и даже на мобилке";
...
export const FACE = {
	...
	worldHeight: 16,
	/** Lift the portrait so the head reads above the headline. */
	offsetY: 1.2,
	/** Horizontal centering offset (0 = centered). */
	offsetX: 0,
