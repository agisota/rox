...
function SupersetLogo() {
	return (
		<span className="inline-flex items-center gap-2 text-foreground">
			<span className="grid size-6 place-items-center rounded bg-foreground text-xs font-semibold text-background">
				СА
			</span>
