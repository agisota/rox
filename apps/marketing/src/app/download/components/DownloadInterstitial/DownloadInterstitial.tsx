					...
					{showWaitlist ? (
						<>
							...
							<p className="text-sm text-muted-foreground sm:text-base">
								Мы готовим Rox для Windows и Linux. Оставьте email, и мы
								сообщим, как только он будет готов.
							</p>
						...
						<>
							<h1
								...
								style={{ fontFamily: "var(--font-ibm-plex-mono), monospace" }}
							>
								Сейчас вы получите Rox
							</h1>
							<p className="text-sm text-muted-foreground sm:text-base">
								Загрузка начнется автоматически. Если она не началась, можно{" "}
								<a
