...
export const metadata: Metadata = {
	title: "Сообщество",
	description:
		"Присоединяйтесь к сообществу Rox, чтобы получать помощь, делиться идеями и следить за новостями и обновлениями.",
	alternates: {
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-8">
				...
				<header className="text-center mb-12 sm:mb-16">
					...
					<p className="mt-4 sm:mt-6 text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
						...
						<span className="font-semibold italic">Rox</span>, чтобы получать
						помощь, делиться идеями и следить за новостями и обновлениями.
					</p>
				</header>
