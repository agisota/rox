...
export const metadata: Metadata = {
	title: "Сообщество",
	description:
		"Присоединяйтесь к сообществу Rox, чтобы получать помощь, делиться идеями и следить за последними новостями и обновлениями.",
	alternates: {
...
const COMMUNITY_LINKS = [
	...
	{
		name: "YOUTUBE",
		href: "https://www.youtube.com/@agisota",
		cta: "ПОДПИСАТЬСЯ",
		icon: (
			<svg width="48" height="48" viewBox="0 0 24 24" fill="currentColor">
				<title>YouTube</title>
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-8">
				...
				<header className="text-center mb-12 sm:mb-16">
					...
					<p className="mt-4 sm:mt-6 text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
						<GlossaryText text="Присоединяйтесь к сообществу Rox, чтобы получать помощь, делиться идеями и следить за последними новостями и обновлениями." />
					</p>
				</header>
