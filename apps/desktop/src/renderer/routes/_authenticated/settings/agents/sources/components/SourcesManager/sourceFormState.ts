 ...
 * `apps/web/src/app/(agents)/agents/sources/components/SourcesManager/sourceFormState.ts`
 * — copied verbatim so the desktop surface shapes IDENTICAL payloads for the
 * cross-platform `agentSource.create` / `agentSource.update` procedures.
 *
