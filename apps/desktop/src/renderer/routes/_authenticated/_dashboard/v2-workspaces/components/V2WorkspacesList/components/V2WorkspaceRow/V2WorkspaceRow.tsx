						...
						<Tooltip delayDuration={300}>
							<TooltipTrigger asChild>
								<Button
									...
									aria-pressed
									aria-label="Открепить от сайдбара"
									className={cn(
							...
							<TooltipContent side="right">
								{isCurrentRoute
									? "Нельзя открепить текущий воркспейс"
						...
						<Tooltip delayDuration={300}>
							<TooltipTrigger asChild>
								<Button
									...
									aria-pressed={false}
									aria-label="Закрепить в сайдбаре"
							...
							<TooltipContent side="right">Закрепить в сайдбаре</TooltipContent>
						</Tooltip>
					)}
				</div>
				...
				<span className="flex min-w-0 items-center gap-2">
					{isMainWorkspace ? (
						<Tooltip delayDuration={300}>
							...
							<TooltipContent side="top">Основной воркспейс</TooltipContent>
						</Tooltip>
					) : null}
					<span
