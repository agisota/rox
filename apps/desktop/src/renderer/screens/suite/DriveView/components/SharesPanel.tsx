...
/**
 * Active public shares with copy + revoke, ported from the web `SharesPanel`.
 * Cache-first: renders the last known shares immediately; skeleton only while
 * there is no data and the query is still loading. Revoked rows are filtered
 * out (the server stamps `revokedAt`). Rendered inside the Drive shares Sheet.
 */
