...
import { ClickableFilePath } from "@rox/ui/ai-elements/clickable-file-path";
import { ReadFileTool } from "@rox/ui/ai-elements/read-file-tool";
...
const TOOL_META: Record<string, ToolMeta> = {
	...
	mastra_workspace_write_file: { label: "Запись", icon: FileIcon },
	mastra_workspace_edit_file: { label: "Правка", icon: FileTextIcon },
	mastra_workspace_read_file: { label: "Чтение", icon: FileIcon },
	mastra_workspace_list_files: { label: "Список файлов", icon: FolderIcon },
	mastra_workspace_file_stat: { label: "Проверка файла", icon: FileSearchIcon },
	mastra_workspace_search: { label: "Поиск", icon: SearchIcon },
	mastra_workspace_mkdir: { label: "Создать каталог", icon: FolderIcon },
	mastra_workspace_delete: { label: "Удаление", icon: FileIcon },
	ast_smart_edit: { label: "Умная правка", icon: CodeIcon },
	web_fetch: { label: "Загрузка из сети", icon: GlobeIcon },
	web_search: { label: "Веб-поиск", icon: GlobeIcon },
};
